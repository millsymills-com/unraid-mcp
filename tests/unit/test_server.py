...
class TestModeGating:
    ...
    async def test_removed_user_mutation_tools_are_absent(self):
        # Regression for #57: the Unraid API 4.32+ schema dropped
        # `addUser`/`deleteUser`/`users`, so these tools are gone.
        config = _make_config(unraid_mode=UnraidMode.READWRITE)
