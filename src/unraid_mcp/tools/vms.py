...
def register_vm_tools(mcp: FastMCP) -> None:
    ...
    @unraid_tool(mcp, tags={"write", "vms"}, annotations={"readOnlyHint": False, "destructiveHint": False})
    ...
    @unraid_tool(mcp, tags={"write", "vms"}, annotations={"readOnlyHint": False, "destructiveHint": True})
