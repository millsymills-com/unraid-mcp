...
def register_array_tools(mcp: FastMCP) -> None:
    ...
    @unraid_tool(mcp, tags={"write", "array"}, annotations={"readOnlyHint": False, "destructiveHint": False})
    ...
    @unraid_tool(mcp, tags={"write", "array"}, annotations={"readOnlyHint": False, "destructiveHint": True})
